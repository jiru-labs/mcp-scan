...
from mcp_audit import report
from mcp_audit.parsers import MCPServer
from mcp_audit.report import Report, UnknownFormat, WouldOverwriteConfig
from mcp_audit.rules import Finding, Severity, load_rules
...
class TestJson:
    ...
    def test_it_is_valid_json(self) -> None:
        ...
        assert document["tool"]["name"] == "mcp-audit"
...
class TestWrite:
    ...
    def test_an_unrelated_double_extension_still_writes_by_its_last(
        ...
        path = tmp_path / "mcp-audit.2026-07-11.json"
...
def _scan_of(config: Path) -> Report:
    ...
    """
    from mcp_audit.parsers import parse_config_file
    from mcp_audit.rules import run_rules
