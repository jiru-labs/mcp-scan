...
carries both, and mcp-audit's findings arrive in the Security tab as security
...
from mcp_audit.rules import Finding, Severity
...
#: Where mcp-audit lives, for the tool block of a report read far from here.
PROJECT_URL = "https://github.com/jiru-labs/mcp-audit"
...
def to_markdown(report: Report) -> str:
    ...
    lines += [
        "---",
        "",
        f"Generated by [mcp-audit](https://github.com/jiru-labs/mcp-audit) "
...
def _refuse_to_overwrite_a_config(report: Report, path: Path) -> None:
    ...
    if _resolved(path) in scanned:
        raise WouldOverwriteConfig(
            ...
            f"this scan just read. Pick another path — mcp-audit does not modify "
